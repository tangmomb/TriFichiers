...
SCRIPTS = {
    "Déplacer photos": {
        "file": "CopierPhotoVersDossierPrecis.py",
    ...
    "Ramène à la racine": {
        "file": "RameneFichiersALaRacine.py",
    ...
    "Trouver les fichiers d'une date précise": {
        "file": "TrouverFichierDuneDatePrecise.py",
    ...
    "Créer des sous-dossiers aléatoires": {
        "file": "SousDossiersAleatoires.py",
